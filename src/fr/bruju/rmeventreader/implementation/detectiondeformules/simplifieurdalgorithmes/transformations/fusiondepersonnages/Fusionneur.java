...
public class Fusionneur implements Unificateur {
	...
	public AlgorithmeEtiquete unifier(AlgorithmeEtiquete algo1, AlgorithmeEtiquete algo2, BaseDePersonnages personnages) {
		...
		SeparateurParHPDeMonstres.ClassificateurMonstreCible c1 = (SeparateurParHPDeMonstres.ClassificateurMonstreCible) algo1.getClassificateurs()[algo1.getClassificateurs().length - 1];
		SeparateurParHPDeMonstres.ClassificateurMonstreCible c2 = (SeparateurParHPDeMonstres.ClassificateurMonstreCible) algo2.getClassificateurs()[algo2.getClassificateurs().length - 1];
