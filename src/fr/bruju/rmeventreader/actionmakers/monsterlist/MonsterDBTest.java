package fr.bruju.rmeventreader.actionmakers.monsterlist;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import fr.bruju.rmeventreader.actionmakers.monsterlist.actionmaker.CompleterWithShowPicture;
import fr.bruju.rmeventreader.actionmakers.monsterlist.actionmaker.DropCompleter;
import fr.bruju.rmeventreader.actionmakers.monsterlist.actionmaker.FinDeCombat;
import fr.bruju.rmeventreader.actionmakers.monsterlist.actionmaker.MonsterDatabaseMaker;
import fr.bruju.rmeventreader.actionmakers.monsterlist.autotraitement.ActionAutomatique;
import fr.bruju.rmeventreader.actionmakers.monsterlist.autotraitement.AutoActionMaker;
import fr.bruju.rmeventreader.actionmakers.monsterlist.autotraitement.AutoCorrespondeur;
import fr.bruju.rmeventreader.actionmakers.monsterlist.autotraitement.InitialisateurTotal;
...
import fr.bruju.rmeventreader.actionmakers.monsterlist.metier.Monstre.RemplacementDrop;
import fr.bruju.rmeventreader.actionmakers.monsterlist.metier.Monstre.RemplacementNom;
