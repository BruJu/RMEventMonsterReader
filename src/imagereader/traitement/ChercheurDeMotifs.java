...
public class ChercheurDeMotifs {
	...
	/**
	 * Parcours les colonnes non explorées.
	 * Renvoie le premier motif trouvé sous forme de nombres quand il a trouvé une colonne non vide
	 * 
	...
	/**
	 * Permet d'encadrer le motif trouvé, en supposant que l'on connait déjà 
	 * la borne de gauche qui est dans colActuelle
	 * 
	 * @return Le motif trouvé sous forme numérique
	 */
	private int[] cadrer() {
	...
	/**
	 * Converti les bornes trouvées pour un motif en une série de nombres le
	 * représentant
	 * @param xMin La borne gauche
	 * @param xMax La borne droite
	 * @param yMin La borne haute
	 * @param yMax La borne basse
	 * @return La liste des nombres représentant le motif
	 * Avec xi le nombre à la ligne i,
	 * si xi mod 2^p = 1, alors le pixel (i-1, p) est allumé sur le motif
	 */
	 ...
	 * 
	 * Si il n'y est pas, affiche le mot ayant posé problème, le motif
	 * ayant posé problème et la ligne de code à ajouter à SymboleReconnus
	 * afin de compléter la liste des motifs préexistants
